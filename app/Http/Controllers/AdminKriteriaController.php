...
class AdminKriteriaController extends Controller
{
    ...
    public function new()
    {
        ...
        $this->data['action'] = 'admin/kriteria/save';
    ...
    public function edit($id)
    {
        ...
        $this->data['fieldTypes'] = (new Kriteria())->getField();
        $this->data['load'] = $rows;
        $this->data['action'] = 'admin/kriteria/update/'.$rows->id;
    ...
    public function detail($id)
    {
        ...
        $this->data['page'] = 'admin/kriteria/'.$rows->id;

        return view('admin/kriteria/sub', $this->data);
    }
    ...
    public function destroy_sub($od, $id)
    {
        ...
        return redirect('admin/kriteria/detail/'.$od);
    }
