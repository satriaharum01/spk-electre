...
class MahasiswaAlternatifController extends Controller
{
    public function __construct()
    {
        $this->middleware('auth');
        $this->data['title'] = 'Data Alternatif';
        $this->data[ 'link' ] = '/mahasiswa/alternatif';
        $this->page = 'mahasiswa/alternatif';
        $this->view = 'mahasiswa/alternatif/index';
    ...
    public function index()
    {
        ...
        return view('mahasiswa/alternatif/index', $this->data);
    }
    ...
    public function new()
    {
        ...
        $this->data['action'] = 'mahasiswa/alternatif/save';
    ...
    public function edit($id)
    {
        ...
        $this->data['fieldTypes'] = (new Alternatif())->getField();
        $this->data['load'] = $rows;
        $this->data['action'] = 'mahasiswa/alternatif/update/'.$rows->id;
