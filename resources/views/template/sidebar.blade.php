...
<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{ (request()->is('admin/penilaian')) ? 'active' : '' }}{{ (request()->is('admin/penilaian/*')) ? 'active' : '' }}" href="{{ route ('admin.penilaian') }}"><i class="app-menu__icon bi bi-bookmark-check"></i><span class="app-menu__label">Penilaian</span></a></li>
        ...
        <li><a class="app-menu__item {{ (request()->is('mahasiswa/penilaian')) ? 'active' : '' }}{{ (request()->is('mahasiswa/penilaian/*')) ? 'active' : '' }}" href="{{ route ('mahasiswa.penilaian') }}"><i class="app-menu__icon bi bi-bookmark-check"></i><span class="app-menu__label">Penilaian</span></a></li>
