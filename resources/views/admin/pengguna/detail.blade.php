...
<div class="col-md-6 col-lg-12">
    <div class="form-group mb-2">
        ...
        <input type="text" class="bg-body-secondary form-control" name="nama_alternatif" value="{{$load->nama}}" readonly/>
    </div>
</div>
      <form id="compose-form" class="" method="POST" enctype="multipart/form-data" action="{{url($action)}}">
      @csrf
      <input type="number" class="form-control d-none" name="id_alternatif" value="{{$load->id}}" readonly/>
