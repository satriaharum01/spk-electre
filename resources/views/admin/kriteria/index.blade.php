...
<script>
      ...
      columns: [
        ...
        },
        {
          ...
          render: function (data, type, row) {
            return (
                '<button type="button" class="btn btn-info btn-eye" data-id="' + data +'"><i class="fa fa-eye"></i> </button>\
  ...
  $("body").on("click", ".btn-add", function () {
    window.location.href = "{{route('admin.kriteria.new')}}";
  })

  $("body").on("click", ".btn-edit", function () {
    var Id = $(this).attr("data-id");
    var url = "{{ route('admin.kriteria.edit', ':id') }}".replace(':id', Id);
    window.location.href = url;
  })

  $("body").on("click", ".btn-eye", function () {
    var Id = $(this).attr("data-id");
    var url = "{{ route('admin.kriteria.detail', ':id') }}".replace(':id', Id);
    window.location.href = url;
  })
</script>
@endsection